...
from oauth.base_mixin import BaseMixin

class BaiduMixin(BaseMixin):
    ...
    def _on_get_user_info(self, future, session, fields, user):
        ...
        if 'portrait' in fields:
            fieldmap['portrait'] = '%s%s' % ('http://tb.himg.baidu.com/sys/portrait/item/', fieldmap['portrait'])
    ...
    def baidu_request(self, path, callback, access_token=None,
                      post_args=None, **args):
        url = "https://openapi.baidu.com" + path
        all_args = {}
        if access_token:
        ...
        callback = self.async_callback(self._on_baidu_request, callback)
        http = self.get_auth_http_client()
