...
class OrderFormGrid(gridlib.Grid):
    def __init__(self, parent):
        gridlib.Grid.__init__(self, parent, -1)
        self.moveTo = None
        self.Bind(wx.EVT_IDLE, self.OnIdle)
        self.CreateGrid(25, 6)
...
#         self.SetCellValue(6, 3, "You can veto editing this cell")
        ...
        self.SetColLabelValue(0, "编号")
        self.SetColLabelValue(1, "商品名称")
        self.SetColLabelValue(2, "规格")
        self.SetColLabelValue(3, "数量")
        self.SetColLabelValue(4, "单价")
        self.SetColLabelValue(5, "金额")
        self.SetColLabelValue(6, "货位")
...
#         self.Bind(gridlib.EVT_GRID_EDITOR_CREATED, self.OnEditorCreated)
    ...
    def OnEditorHidden(self, evt):
        if evt.GetRow() == 6 and evt.GetCol() == 3 and \
           wx.MessageBox("Are you sure you wish to  finish editing this cell?", "Checking", wx.YES_NO) == wx.NO:
            evt.Veto()
            return
